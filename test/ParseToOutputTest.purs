...
import Generated (Expr, ParseApp, ParseAssert, ParseAttrpath, ParseAttrs, ParseAttrset, ParseBinary, ParseBind, ParseComment, ParseEllipses, ParseExpression, ParseFloat, ParseFormal, ParseFormals, ParseFunction, ParseHpath, ParseIdentifier, ParseIf, ParseIndentedString, ParseInherit, ParseInteger, ParseInterpolation, ParseLet, ParseLetAttrset, ParseParenthesized, ParsePath, ParseRecAttrset, ParseSelect, ParseSpath, ParseString, ParseUnary, ParseUri, ParseWith, ParseList)
...
-- testParseWith = wtfIsThis (Proxy :: Proxy ParseWith) :: Proxy Expr
