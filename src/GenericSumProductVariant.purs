module GenericSumProductVariant where
...
-- this module is like purescript-kishimen, but we bend some rules here to make things easier
...
instance genericSumToVariantProduct ::
  ( GenericSumToVariantArg l a
  , GenericSumToVariantArg r b
  ) => GenericSumToVariantArg (GR.Product l r) (Tuple a b) where
  genericSumToVariantArgImpl (GR.Product a b) = Tuple (genericSumToVariantArgImpl a) (genericSumToVariantArgImpl b)
  variantArgImplToGenericSumImpl (Tuple a b) = GR.Product (variantArgImplToGenericSumImpl a) (variantArgImplToGenericSumImpl b)
